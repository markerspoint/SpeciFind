...
<body
    ...
    <div
        ...
        <div id="result" class="hidden mt-8 text-gray-700 text-left w-full break-words">
            <div class="bg-green-100 text-green-800 p-4 rounded mt-4 space-y-2">
                <p><strong>Scientific Name:</strong> <span id="result-name"></span></p>
                <p><strong>Family:</strong> <span id="result-family"></span></p>
        ...
        <div id="error"
            class="hidden bg-red-100 text-red-700 p-4 rounded-lg mt-4 shadow-inner w-full break-words"></div>

        <!-- Loading State -->
        <p id="loading" class="hidden text-gray-600 text-center mt-4"></p>
